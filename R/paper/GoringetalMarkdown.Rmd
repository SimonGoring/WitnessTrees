...
***
```{r fig1_output,echo=FALSE,warning=FALSE,message=FALSE,fig.width=4,fig.height = 3,dpi=300}
...
***
```{r fig2_output, echo = FALSE, warning=FALSE, message=FALSE, fig.width=4, fig.height = 4, dpi=300}
...
***
```{r fig3_output, echo = FALSE, warning=FALSE, message=FALSE, fig.width=5, fig.height = 5, dpi=300}
...
***
```{r fig4_output, echo=FALSE, message=FALSE, warning=FALSE, width=5, fig.height = 5, dpi=300}
...
```{r fig5_output, echo = FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height = 5, dpi=150}
composition.plots
```

***
```{r fig6_output, dpi=150, echo = FALSE, message = FALSE, warning=FALSE, results='hide', fig.width=6, fig.height=6}
...
```{r fig7_output, echo = FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height = 5, dpi=150}
...
***
```{r fig8_output, echo = FALSE, message = FALSE, warning=FALSE, fig.width=7, fig.height = 3, dpi=300}
...
***
```{r fig9_output, echo = FALSE, message = FALSE, warning=FALSE, fig.width=7, fig.height = 6, dpi=150}
trans.plot
```
...
***
```{r fig10_output, echo = FALSE, warning=FALSE, message=FALSE, results='hide', fig.width=7, fig.height = 5, dpi=150}

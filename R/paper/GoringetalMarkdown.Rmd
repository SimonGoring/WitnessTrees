...
```{r figure2_angles, echo = FALSE, warning=FALSE, message=FALSE}
...
```{r fig3stemdensity_basalarea_biomass, echo = FALSE, warning=FALSE, message=FALSE, fig.width=5, fig.height = 5, dpi=300}

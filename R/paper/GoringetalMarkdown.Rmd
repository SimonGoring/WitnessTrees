...
```{r fig9_calc, echo = FALSE, message = FALSE, warning=FALSE}
...
```{r fig10_calc, echo = FALSE, warning=FALSE, message=FALSE, results='hide'}
...
***
```{r fig10_output, echo = FALSE, warning=FALSE, message=FALSE, results='hide', fig.width=7, fig.height = 5, dpi=300, dev=c('png','postscript','tiff')}

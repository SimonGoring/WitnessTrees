...
```{r fig7_output, echo = FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height = 5, dpi=300, dev=c('png','postscript','tiff')}
...
***
```{r fig8_output, echo = FALSE, message = FALSE, warning=FALSE, fig.width=7, fig.height = 3, dpi=300, dev=c('png','postscript','tiff')}

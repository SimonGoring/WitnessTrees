...
taxon.conv <- read.csv('data/input/fullpaleon_conversion_v0.3.csv', header=TRUE, stringsAsFactors = FALSE)
...
write.csv(rast.out, 'data/output/gridded/IllinoisData_v0.2.csv')
